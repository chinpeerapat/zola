            ...
            <div className="flex h-full flex-col space-y-0 overflow-y-auto px-4 pb-6">
              {isLoadingModels ? (
                ...
                <div className="flex h-full flex-col items-center justify-center p-6 text-center">
                  ...
                  <a
                    href="https://github.com/chiinpeerapat/smolchat/issues/new?title=Model%20Request%3A%20"
                    target="_blank"
            ...
            <div className="flex h-full flex-col space-y-0 overflow-y-auto px-1 pt-0 pb-0">
              {isLoadingModels ? (
                ...
                <div className="flex h-full flex-col items-center justify-center p-6 text-center">
                  ...
                  <a
                    href="https://github.com/ibelick/smolchat/issues/new?title=Model%20Request%3A%20"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-muted-foreground text-sm underline"
                  >
